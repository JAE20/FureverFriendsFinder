...
--
-- Host: localhost
-- Generation Time: Sep 25, 2025 at 10:58 AM
...
--
-- Table structure for table `tbl_adopter_archive`
--

CREATE TABLE `tbl_adopter_archive` (
  `adopter_id` int(11) NOT NULL,
  `username` varchar(50) DEFAULT NULL,
  `adopter_name` varchar(100) NOT NULL,
  `adopter_contact` varchar(15) DEFAULT NULL,
...
--
-- Table structure for table `tbl_adoption_archive`
--

CREATE TABLE `tbl_adoption_archive` (
  `adoption_id` int(11) NOT NULL,
  `pet_id` int(11) NOT NULL,
  `adopter_id` int(11) NOT NULL,
  `adoption_date` date DEFAULT NULL,
...
--
-- Table structure for table `tbl_adoption_request_archive`
--

CREATE TABLE `tbl_adoption_request_archive` (
  `adoption_request_id` int(11) NOT NULL,
  `pet_id` int(11) NOT NULL,
  `adopter_id` int(11) NOT NULL,
  `request_date` date DEFAULT NULL,
...
--
-- Table structure for table `tbl_archive_log`
--
...
CREATE TABLE `tbl_archive_log` (
  ...
  `operation` enum('ARCHIVE','RESTORE','PERMANENT_DELETE') NOT NULL,
...
--
-- Table structure for table `tbl_pet_archive`
--

CREATE TABLE `tbl_pet_archive` (
  `pet_id` int(11) NOT NULL,
  `pet_owner_id` int(11) NOT NULL,
  `pet_name` varchar(100) NOT NULL,
  `pet_type_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_pet_media_archive`
--

CREATE TABLE `tbl_pet_media_archive` (
  `pet_media_id` int(11) NOT NULL,
  `pet_id` int(11) NOT NULL,
  `pet_media_name` varchar(255) DEFAULT NULL,
  `pet_media_url` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `tbl_pet_owner_archive`
--

CREATE TABLE `tbl_pet_owner_archive` (
  `pet_owner_id` int(11) NOT NULL,
  `pet_owner_name` varchar(100) NOT NULL,
  `pet_owner_contact` varchar(15) DEFAULT NULL,
  `pet_owner_email` varchar(100) DEFAULT NULL,
...
--
-- Indexes for table `tbl_adopter_archive`
--
ALTER TABLE `tbl_adopter_archive`
  ADD PRIMARY KEY (`adopter_id`),
  ADD KEY `idx_adopter_archive_date` (`archived_date`),
  ADD KEY `idx_adopter_archive_by_user` (`archived_by_user_id`);
...
--
-- Indexes for table `tbl_adoption_archive`
--
ALTER TABLE `tbl_adoption_archive`
  ADD PRIMARY KEY (`adoption_id`),
  ADD KEY `idx_adoption_archive_pet` (`pet_id`),
  ADD KEY `idx_adoption_archive_adopter` (`adopter_id`),
  ADD KEY `idx_adoption_archive_date` (`archived_date`),
  ADD KEY `idx_adoption_archive_by_user` (`archived_by_user_id`);
...
--
-- Indexes for table `tbl_adoption_request_archive`
--
ALTER TABLE `tbl_adoption_request_archive`
  ADD PRIMARY KEY (`adoption_request_id`),
  ADD KEY `idx_request_archive_pet` (`pet_id`),
  ADD KEY `idx_request_archive_adopter` (`adopter_id`),
  ADD KEY `idx_request_archive_date` (`archived_date`),
  ADD KEY `idx_request_archive_by_user` (`archived_by_user_id`),
  ADD KEY `idx_request_archive_status` (`status`);

--
-- Indexes for table `tbl_archive_log`
--
ALTER TABLE `tbl_archive_log`
  ADD PRIMARY KEY (`log_id`),
  ADD KEY `idx_archive_log_table` (`table_name`),
  ADD KEY `idx_archive_log_operation` (`operation`),
  ADD KEY `idx_archive_log_date` (`operation_date`),
  ADD KEY `idx_archive_log_user` (`performed_by_user_id`);
...
--
-- Indexes for table `tbl_pet_archive`
--
ALTER TABLE `tbl_pet_archive`
  ADD PRIMARY KEY (`pet_id`),
  ADD KEY `idx_pet_archive_owner` (`pet_owner_id`),
  ADD KEY `idx_pet_archive_type` (`pet_type_id`),
  ADD KEY `idx_pet_archive_date` (`archived_date`),
  ADD KEY `idx_pet_archive_by_user` (`archived_by_user_id`),
  ADD KEY `idx_pet_archive_status` (`adoption_status`);
...
--
-- Indexes for table `tbl_pet_media_archive`
--
ALTER TABLE `tbl_pet_media_archive`
  ADD PRIMARY KEY (`pet_media_id`),
  ADD KEY `idx_media_archive_pet` (`pet_id`),
  ADD KEY `idx_media_archive_date` (`archived_date`),
  ADD KEY `idx_media_archive_by_user` (`archived_by_user_id`);
...
--
-- Indexes for table `tbl_pet_owner_archive`
--
ALTER TABLE `tbl_pet_owner_archive`
  ADD PRIMARY KEY (`pet_owner_id`),
  ADD KEY `idx_pet_owner_archive_date` (`archived_date`),
  ADD KEY `idx_pet_owner_archive_by_user` (`archived_by_user_id`);
...
ALTER TABLE `users_archive`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_users_archive_date` (`archived_date`),
  ADD KEY `idx_users_archive_by_user` (`archived_by_user_id`),
  ADD KEY `idx_users_archive_role` (`role`);
...
--
-- AUTO_INCREMENT for table `tbl_archive_log`
--
ALTER TABLE `tbl_archive_log`
